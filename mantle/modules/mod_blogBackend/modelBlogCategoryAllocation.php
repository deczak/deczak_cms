...
include_once 'shemeBlogCategoryAllocation.php';	

class 	modelBlogCategoryAllocation extends CModel
{
	public function
	__construct()
	{		
		parent::__construct('BlogCategoryAllocation');		
		$this -> m_sheme = new shemeBlogCategoryAllocation();
	}	
