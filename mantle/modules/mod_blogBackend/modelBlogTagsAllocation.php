...
include_once 'shemeBlogTagsAllocation.php';	

class 	modelBlogTagsAllocation extends CModel
{
	public function
	__construct()
	{		
		parent::__construct('BlogTagsAllocation');		
		$this -> m_sheme = new shemeBlogTagsAllocation();
	}	
