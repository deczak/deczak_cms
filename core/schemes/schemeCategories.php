...
class schemeCategories extends CScheme
{
	public function
	__construct()
	{
		...
		$this -> addColumn('category_id', DB_COLUMN_TYPE_INT) -> setKey('PRIMARY') -> setAttribute(DB_COLUMN_ATTR_UNSIGNED) -> setAutoIncrement() -> setSystemId();
