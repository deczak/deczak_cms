<div class="be-module-container forms-view">
	<div>
		<div class="inter-menu">
			...
			<hr>
			<ul>
			<li><a class="darkblue" href="#user-create"><?php echo CLanguage::string('MOD_BEUSER_FM_CREATEUSER'); ?></a></li>
			</ul>
			<hr>
		</div>
	</div>
	<div>
		...
		<fieldset class="ui fieldset submit-able" id="user-create" data-xhr-target="create">
			<legend><?php echo CLanguage::string('MOD_BEUSER_FM_CREATEUSER'); ?></legend>
