	...
	<table class="table-overview">
		<thead>
			<tr>
				...
				<td class="user-id"><?php echo CLanguage::string('MOD_BEUSER_OV_TABLE_USERID'); ?></td>
				<td><?php echo CLanguage::string('USERNAME'); ?></td>
				<td class="time-create"><?php echo CLanguage::string('TIME_CREATE_AT'); ?></td>
				<td class="last-login"><?php echo CLanguage::string('MOD_BEUSER_OV_TABLE_LASTLOGIN'); ?></td>
				<td class="num-of-logins"><?php echo CLanguage::string('MOD_BEUSER_OV_TABLE_NUMLOGIN'); ?></td>
...
<template id="template-table-row">
	...
	<td class="bach-item-menu"><span>&equiv;</span><div class="dropdown-content"><div></div><a href="<?php echo CMS_SERVER_URL_BACKEND . $pageRequest -> urlPath; ?>user/%user_id%"><?php echo CLanguage::string('BUTTON_EDIT'); ?></a></div></td>
