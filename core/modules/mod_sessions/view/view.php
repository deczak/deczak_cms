...
<div class="be-module-container forms-view">
	<div>
		<div class="inter-menu">
			...
			<hr>
			<ul>
			<li><a class="darkblue" href="#session-information"><?php echo CLanguage::string('SESSION INFORMATION'); ?></a></li>
			<li><a class="darkblue" href="#session-access"><?php echo CLanguage::string('M_BESESSION_HISTORY'); ?></a></li>
			</ul>
			<hr>
			<div class="delete-box">	
				<?php if($enableDelete) { ?>
					<fieldset class="ui fieldset button-only" data-xhr-target="delete" data-xhr-overwrite-target="delete/<?php echo $_dataSet -> data_id; ?>">	
	...
	<div>
		...
		<fieldset class="ui fieldset" id="session-information" data-xhr-target="session-information">
			...
			<legend><?php echo CLanguage::string('SESSION INFORMATION'); ?></legend>

			<div>
		
				<div class="group width-100">

					<div class="group-head width-100"><?php echo CLanguage::string('USER'); ?></div>
					...
					<div class="input width-50">
						<label><?php echo CLanguage::string('M_BESESSION_SESSIONID'); ?></label>
						<input type="text" name="denied_desc" value="<?php echo $_dataSet -> session_id; ?>" maxlength="250">
					</div>

					<div class="input width-25">
						<label><?php echo CLanguage::string('DATE'); ?></label>
				...
				<div class="group width-100">
					...
					<div class="input width-100">
						<label><?php echo CLanguage::string('M_BESESSION_USERAGENT'); ?></label>
				...
				<div class="group width-100">
					...
					<div class="input width-100">
						<label><?php echo CLanguage::string('M_BESESSION_REFERRER'); ?></label>
		...
		<fieldset class="ui fieldset" id="session-access" data-xhr-target="session-access">
			...
			<legend><?php echo CLanguage::string('M_BESESSION_HISTORY'); ?></legend>
				...
				<div class="group width-100">
					<div class="input width-100">
						...
						<table id="table-access">
							<thead>
								<tr>
									<td><?php echo CLanguage::string('TIMESTAMP'); ?></td>
									<td><?php echo CLanguage::string('PAGE'); ?></td>
								</tr>
							</thead>
							<tbody>
