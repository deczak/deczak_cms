	...
	<div>
		...
		<fieldset class="ui fieldset submit-able" id="user-create" data-xhr-target="user-create">
			...
			<div class="submit-container">
				<button class="ui button icon labeled trigger-submit-fieldset" type="button" disabled><i class="fas fa-save"></i><?php echo CLanguage::get() -> string('MOD_BEUSER_FM_BTN_SAVE'); ?></button>
