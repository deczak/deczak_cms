...
<div class="be-module-container forms-view">
	<div>
		<div class="ui inter-menu">
			...
			<hr>
			<ul>
			<li><a class="darkblue" href="#user-agent"><?php echo CLanguage::string('M_BEUSERAG_USERAGENT'); ?></a></li>
			</ul>
			<hr>
	...
	<div>
		...
		<fieldset class="ui fieldset submit-able" id="user-agent" data-xhr-target="<?= (!$dataset ? 'create' : 'edit'); ?>" <?= ($dataset !== false ? 'data-xhr-overwrite-target="edit/'. $dataset -> data_id .'"' : ''); ?>>
			...
			<legend><?php echo CLanguage::string('M_BEUSERAG_USERAGENT'); ?></legend>
			<div>

				<!-- user agent -->
				<div class="group width-100">

					<div class="group-head width-100"><?php echo CLanguage::string('M_BEUSERAG_USERAGENT'); ?></div>

					<div class="input width-25">
						<label><?php echo CLanguage::string('M_BEUSERAG_AGENTNAME'); ?></label>
						<input type="text" name="agent_name" value="" maxlength="35">
					</div>

					<div class="input width-50">
						<label><?php echo CLanguage::string('M_BEUSERAG_AGENTSUFFIX'); ?></label>
						<input type="text" name="agent_suffix" value="" maxlength="75">
					</div>
			
					<div class="input width-25">
						<label><?php echo CLanguage::string('ALLOWED'); ?></label>
